...
function revenueChart(id, productLabels=[], productInfo=[]){
    let colors = [];
...
function revenueChartYear(id, productLabelsYear=[], productInfoYear=[]){
    let colors = [];
...
function revenueChartQuarter(id, productLabelsQuarter=[], productInfoQuarter=[]){
    let colors = [];
