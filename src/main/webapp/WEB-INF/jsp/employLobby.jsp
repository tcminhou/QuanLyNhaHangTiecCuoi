...
<!--thêm sảnh-->
<c:url value="/employ/lobby" var="action"/>
<form:form method="post" action="${action}" modelAttribute="lobby" enctype="multipart/form-data">
    ...
    <div>
        <input type="submit" value="Thêm sảnh" class="btn btn-danger" style="margin-top: 10px"/>
    </div>
</form:form>
...
<script src="<c:url value="/js/employLobby.js" />"></script>
<script>
